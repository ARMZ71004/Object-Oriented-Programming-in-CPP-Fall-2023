...
void List::push_front(List &list, const Profession &d)                   
{
...
void List::push_back(List &list, const Profession &d)                    
{
    if(list.head == nullptr) {                     
        push_front(list, d);
        return;
...
Iterator List::insert(List &list, Iterator itr, const Profession &d)     
{
